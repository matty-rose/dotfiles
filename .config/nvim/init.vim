...
" Ale
let g:ale_linters = {'javascript': ['eslint'], 'typescript': ['eslint'], 'python': ['flake8'], 'go': ['golint'], 'dockerfile': ['hadolint'], 'terraform': ['tflint']}
let g:ale_fixers = {'python': ['black', 'isort'], 'go': ['goimports'], 'hcl': ['terraform'], 'javascript': ['prettier'], 'typescript': ['prettier'], 'yaml': ['prettier'], 'terraform': ['terraform']}
